...
import scriptureRouter from './modules/scripture'
...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: '抄经堂管理系统', icon: 'dashboard', affix: true }
      }
    ]
  },
  {
  ...
  },
  {
    path: '/system',
    component: Layout,
    redirect: '/system/modifyPassword',
    hidden: true,
    children: [
      {
        path: 'modifyPassword',
        component: () => import('@/views/system/modifyPassword'),
        name: 'ModifyPassword',
